...
from core_rt.utils.dataset_mix import build_foundation_capped_mix
...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/scenflow_finalpass',
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/ETH3D',
                 split='training'):
        ...
        disp_list = sorted(glob(osp.join(root, 'two_view_training_gt/*/disp0GT.pfm'))) \
            if split == 'training' else [osp.join(root, 'two_view_training_gt/playground_1l/disp0GT.pfm')] * len(
            image1_list)
...
class SintelStereo(StereoDataset):
    def __init__(self, aug_params=None,
                 root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/Sintel'):
...
class FallingThings(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/FallingThings'):
...
class TartanAir(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/TartanAir'):
...
class CREStereoDataset(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/crestereo_dataset'):
...
class CARLA(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/carla-highres'):
...
class InStereo2K(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/InStereo2K'):
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2015',
                 image_set='training'):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)

        root_12 = '/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2012'
        ...
        root_15 = '/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2015'
...
class KITTI_2012(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2012',
                 image_set='training'):
        super(KITTI_2012, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)
        root_12 = '/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2012'  # '/data/lwj/kitti-1210/2012/'#
        image1_list = sorted(glob(os.path.join(root_12, image_set, 'colored_0/*_10.png')))
        image2_list = sorted(glob(os.path.join(root_12, image_set, 'colored_1/*_10.png')))
        disp_list = sorted(
            glob(os.path.join(root_12, 'training', 'disp_occ/*_10.png'))) if image_set == 'training' else [osp.join(
...
class KITTI_2015(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2015',
        ...
        root_15 = '/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2015'  # '/data/lwj/kitti-1210/2015/'#
        image1_list = sorted(glob(os.path.join(root_15, image_set, 'image_2/*_10.png')))
        image2_list = sorted(glob(os.path.join(root_15, image_set, 'image_3/*_10.png')))
        disp_list = sorted(
            glob(os.path.join(root_15, 'training', 'disp_occ_0/*_10.png'))) if image_set == 'training' else [osp.join(
...
class VKITTI2(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/vkitti2'):
        super(VKITTI2, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispVKITTI2)
        assert os.path.exists(root)

        image1_list = sorted(glob(os.path.join(root, 'vkitti2_rgb/Scene*/*/frames/rgb/Camera_0/rgb*.jpg')))
        image2_list = sorted(glob(os.path.join(root, 'vkitti2_rgb/Scene*/*/frames/rgb/Camera_1/rgb*.jpg')))
        disp_list = sorted(glob(os.path.join(root, 'vkitti2_depth/Scene*/*/frames/depth/Camera_0/depth*.png')))
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/Middlebury',
                 resolution='F'):
        super(Middlebury, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispMiddlebury)
        assert os.path.exists(root)
        assert resolution in "FHQ"
        lines = list(map(osp.basename, glob(os.path.join(root, "trainingH/*"))))
        image1_list = sorted([os.path.join(root, f'training{resolution}', f'{name}/im0.png') for name in lines])
        image2_list = sorted([os.path.join(root, f'training{resolution}', f'{name}/im1.png') for name in lines])
        disp_list = sorted([os.path.join(root, f'training{resolution}', f'{name}/disp0GT.pfm') for name in lines])
...
class Middleburys(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/wjy/dataset/Middleburys', split='2014', resolution='F'):
        super(Middleburys, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispMiddlebury)
        assert os.path.exists(root)
        assert split in ["2005", "2006", "2014", "2021", "MiddEval3"]
        if split == "2005":
            scenes = [scene for scene in (Path(root) / "2005").glob("*")
                      if (scene / "view1.png").is_file()
                      and (scene / "view5.png").is_file()
                      and (scene / "disp1.png").is_file()]
            for scene in scenes:
...
def fetch_dataloader(args):
    ...
    if args.train_datasets == 'sceneflow':
        ...
        new_dataset = KITTI(aug_params, image_set='training')
        logging.info(f"Adding {len(new_dataset)} samples from KITTI 2012+2015")

    elif args.train_datasets == 'kitti_2012':
        new_dataset = KITTI_2012(aug_params)
        logging.info(f"Adding {len(new_dataset)} samples from KITTI 2012")

    elif args.train_datasets == 'kitti_2015':
        new_dataset = KITTI_2015(aug_params)
        logging.info(f"Adding {len(new_dataset)} samples from KITTI 2015")

    elif args.train_datasets == 'driving_scene':
        kitti = KITTI(aug_params, image_set='training')
        ...
        mbeval3 = Middleburys(aug_params, split='MiddEval3', resolution='H')
        logging.info(f"Adding {len(mbeval3)} samples from Middlebury Eval3")
        mbeval3_f = Middleburys(aug_params, split='MiddEval3', resolution='F')
        logging.info(f"Adding {len(mbeval3)} samples from Middlebury Eval3")
        fallingthings = FallingThings(aug_params)
        logging.info(f"Adding {len(fallingthings)} samples from FallingThings")
    ...
    elif args.train_datasets == 'zero_shot':
        sceneflow = SceneFlowDatasets(aug_params, dstype='frames_finalpass')
        logging.info(f"Adding {len(sceneflow)} samples from SceneFlow")
        crestereo = CREStereoDataset(aug_params)
        logging.info(f"Adding {len(crestereo)} samples from CREStereo")
        tartanair = TartanAir(aug_params)
        logging.info(f"Adding {len(tartanair)} samples from TartanAir")
        new_dataset = sceneflow + crestereo + tartanair
        logging.info(f"Total {len(new_dataset)} samples from zero-shot mixture")

    elif args.train_datasets == 'foundation_zero_shot':
        sceneflow = SceneFlowDatasets(aug_params, dstype='frames_finalpass')
        tartanair = TartanAir(aug_params)
        crestereo = CREStereoDataset(aug_params)
        fallingthings = FallingThings(aug_params)
        vkitti2 = VKITTI2(aug_params)
        instereo2k = InStereo2K(aug_params)
        mix_cfg = getattr(args, "mix", {}) or {}
        seed = int(mix_cfg.get("seed", 666))
        new_dataset, stats = build_foundation_capped_mix(
            sceneflow=sceneflow,
            tartanair=tartanair,
            crestereo=crestereo,
            ...
            seed=seed,
            tartanair_max_total=int(mix_cfg.get("tartanair_max_total", 35000)),
            tartanair_max_per_group=int(mix_cfg.get("tartanair_max_per_group", 100)),
            crestereo_max_total=int(mix_cfg.get("crestereo_max_total", 39000)),
            crestereo_max_per_group=int(mix_cfg.get("crestereo_max_per_group", 1300)),
            exclude_crestereo_tree=bool(mix_cfg.get("exclude_crestereo_tree", True)),
            fallingthings_max_total=int(mix_cfg.get("fallingthings_max_total", 9000)),
            fallingthings_max_per_group=int(mix_cfg.get("fallingthings_max_per_group", 600)),
        )
        logging.info(f"foundation_zero_shot capped mix stats: {stats}")
