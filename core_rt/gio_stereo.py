...
from core_rt.mma import MultiScaleMatchingAttention
from core_rt.context import GlobalConsistencyContextNet
...
class GIOStereo(nn.Module):
    def __init__(self, args):
        ...
        self.cnet = GlobalConsistencyContextNet(in_channels=96, out_channels=context_dim,
        ...
        self.beca = MultiScaleMatchingAttention(channels=96)
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, test_mode=False):
        """ Estimate disparity between a pair of frames """
        ...
        with autocast(enabled=self.args.mixed_precision,
            ...
            match_left, match_right = self.beca(match_left, match_right)
