...
def main(cfg):
    ...
    val_dataset = datasets.Middlebury(
        aug_params={},
        resolution=str(cfg.val_resolution)
    )
            ...
            if (total_step > 0) and (total_step % cfg.val_frequency == 0):
                ...
                with torch.no_grad():
                    for vdata in val_pbar:
                        ...
                        # Middlebury mask: valid + occlusion (same as train_zero_shot.py)
                ...
                if accelerator.is_main_process and elem_num > 0:
                    ...
                    avg_d1 = 100.0 * total_out / elem_num
                    accelerator.log({'val/epe': avg_epe, 'val/d1': avg_d1}, total_step)
